...
// VERSION: 2.5 (CRITICAL FIX: OLA Initialization Denormalization)
// STATUS: Removed experimental global smoothing. Hardened OLA window parameters.
// =================================================================================
...
// Hardened OLA window sizes to prevent unexpected zero values on startup.
...
tdhs_pitch_shifter(semitone_value) =
    // Ensure all parameters passed to ef.transpose are definitely available
...
// Default manual value is 12 (Octave Up) for a clearer test tone.
...
with {
    // Semantic fix from V2.3: Add tiny DC offset for TDHS stability
    ...
    // Smoothed gate for Test Tone ON/OFF transition (using native si.smoo)
